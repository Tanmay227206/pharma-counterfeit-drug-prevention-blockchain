					...
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								...
								PreparedStatement pst=con.prepareStatement("SELECT * from tblshipproduct where dealername='"+firstname+"'&'"+lastname+"' and status='Assign'");
								...
								%>
									...
									<table class="table" style="width:90%;text-align:middle;border:solid 2px;margin: 12px 0 0px 50px;">
										...
										<tr>
											...
											<th>Dealer Name</th>
											<th>Scan & Enter<br> Product Id</th>
											<th>Action</th>
										</tr>
										</thead>
										<tbody>
										<form action="SendOtp" method="post">
											<tr>
												...
												<td><%=rs.getString("total_product") %>
													<input type="hidden" name="total_product" value="<%=rs.getString("total_product")%>" required></td>
												<td><%=rs.getString("cost") %>
													<input type="hidden" name="cost" required></td>
												<td><%=rs.getString("status") %>
													<input type="hidden" name="status" required></td>
												<td><%=rs.getString("dealername") %>
													<input type="hidden" name="dealername" required></td>
												<td><input style="width:110px" type="text" name="TrackingID"></td>
												<td><button type="submit">Send OTP</button></td>
											</tr>
											</form>
										</tbody>
									</table>
