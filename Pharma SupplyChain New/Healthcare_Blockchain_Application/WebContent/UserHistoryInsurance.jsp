      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <% String pname=(String)session.getAttribute("Insurancename"); %>
                    ...
                    <table class="table" style="width:90%;text-align:middle;border:solid 2px;margin: 12px 0 0px 50px;">
                     ...
                     <tr>
                      ...
                      <%
										...
										String quer = null;
										String pemailid=(String)session.getAttribute("Insuranceemailid");										
										try {

											Connection con = Dbconn.conn();

											
											quer = "select * from tblinfoinsurance where Email_IDs='"+pemailid+"'";
