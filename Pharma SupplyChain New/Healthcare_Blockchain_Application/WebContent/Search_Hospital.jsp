...
<body class="">
	<div class="wrapper ">
		<div class="sidebar" data-color="purple" data-background-color="white"
			...
			<div class="logo">
				<a href="#"
					class="simple-text logo-normal"> <b>Pharma SupplyChain</b> </a>
			</div>
				...
				<div class="container-fluid">
					<div class="navbar-wrapper">
						<% String Hospitalname=(String)session.getAttribute("Hospitalname"); %>
           				Welcome To <a style="color: red;" class="navbar-brand" href="#"><%=Hospitalname %></a>
					</div>
							...
							<div class="card">
								...
								<form action="Search_Hospital.jsp" method="post">
									...
									try {
										...
										String str = "select * from tblregister where Hospital_Name='"+Hospitalname+"'";
