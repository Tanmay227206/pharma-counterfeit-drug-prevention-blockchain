...
if(request.getParameter("Login")!=null){
	   out.println("<script>alert('Great.... Login Successfully...');</script>"); 
	}
%>
<body class="">
	<div class="wrapper ">
						    ...
						    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
						      <div class="dropdown-divider"></div>
								<% 
									...
									try {
										PreparedStatement pst=con.prepareStatement("SELECT Name, id FROM tblwholesaler");
										ResultSet rs1=pst.executeQuery();
										while(rs1.next())
										{		
											int wid = rs1.getInt("id");
											String Wholersalername = rs1.getString("Name"); 
									
											/* PreparedStatement ps1=con.prepareStatement("SELECT Name, id FROM tblpharmacy");
									...
									%>
										<a class="dropdown-item" href="ChatBot.jsp?Wholersalername=<%= Wholersalername %>&wid=<%= wid %>"><%=Wholersalername%></a>
									<%
										}
										//}
									} catch (Exception e) {
            			  ...
            			  <div class="col-lg-12 col-md-12">
							<div class="card">
								<div class="card-header card-header-primary">
									<h4 class="card-title ">Pharma SupplyChain System</h4>

								</div>
								<%
								//Connection con = Dbconn.conn();
								//String userId = session.getAttribute("pid").toString();
								//System.out.println("Pharma_Id= "+userId);
								PreparedStatement pst=con.prepareStatement("SELECT * FROM tblpharmacy where Name='"+Pharmacyname+"'");
								ResultSet rs=pst.executeQuery();
								if(rs.next())
								{
									
								%>
									<table class="table" style="width:50%;text-align:middle;border:solid 2px;margin: 12px 0 0px 90px;">
