					...
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								...
								<div align="center">   
					            <font size="4px">Verification have been sent to Patients registered email-id.<br>
								Kindly check Patients mail and enter the code in below text box.</font><br></div>
								<h2 align="center"><b><font color="blue">Enter Verification Code:</font></b></h2>
					            ...
					            <table style="border: 3px solid red" align="center" border="10" width="350px" height="50px" cellpadding="10px">
									<tr>
										...
										<td align="center"><input type="password" name="otpe" id="search-text" size="15" /></td>
									</tr>
									<tr>
								...
								<!-- <form action="VerifyOtp" method="post">
									<table class="table">
										...
										<tr>
					                       <td>Enter OTP</td>
					                       <td><input type="text" name="otp" required="required"></td>
					                    </tr>
