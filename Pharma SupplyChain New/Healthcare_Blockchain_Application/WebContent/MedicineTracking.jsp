					...
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								...
								PreparedStatement pst=con.prepareStatement("SELECT * FROM tblshipproduct where Email_ID='"+Email_ID+"'and payment='Pending'");
					...
					<div class="row"> -->
						<div class="col-md-12">
							<div class="card">
								...
								//String Email_ID = (String)session.getAttribute("emailid");
								//System.out.println("EmailId= "+Email_ID);
								PreparedStatement ps=con.prepareStatement("SELECT * FROM tblmedicine where Email_ID='"+Email_ID+"'");
								ResultSet rs11=ps.executeQuery();
								while(rs11.next())
								{
									String TrackingID = rs11.getString("TrackingID");
								...
								<table class="table" style="width:90%;text-align:middle;border:solid 2px;margin: 12px 0 0px 50px;">
										...
										<tbody>
											<tr>
												<td><%=rs11.getString("OrderId") %></td>
												<td><%=TrackingID %></td>
												<td><%=rs11.getString("Email_ID") %></td>
												<td><%=rs11.getString("hospital") %></td>
												<td><%=rs11.getString("medname") %></td>
												<td><%=rs11.getString("submedname") %></td>
												<td><%=rs11.getString("company") %></td>
												<td><%=rs11.getString("quantity") %></td>
												<td><%=rs11.getString("createdate") %>&nbsp;<%=rs11.getString("createtime") %></td>
												<td><%=rs11.getString("cost") %></td>
											</tr>
										</tbody>
									</table>
									<%}%>
