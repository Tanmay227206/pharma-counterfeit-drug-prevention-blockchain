            ...
            <div class="sidebar-wrapper">
                <ul class="nav">
					<li class="nav-item active"><a class="nav-link"
						href="PharmacyProfile.jsp"> <i class="material-icons">dashboard</i>
							<p>Dashboard</p>
					</a></li>
			              ...
			              <div class="card">
			                <div class="card-header card-header-primary"><br>
			                  ...
			                  <p class="card-category"><b>Manage your Pharmacy Inventory</b></p>		              
									...
									<div align="center">
										<h3><b>Update Medicines Stock</b></h3>
									<br>
									<div align="center">
									...
									PreparedStatement ps = con.prepareStatement("select * from medicine where medicine='"+medicine+"'");
									...
									if(rs.next())
									{
										...
										%>
									<form action="UpdateMedicine" method="get">
									  	<table border="1px" cellpadding="15px" cellspacing="15px" >
											...
											<tr>
												...
												<td><i class="fa fa-inr" style="font-size:14px">
													<input type="text" style="width:142px;height:28px;" name="price" value="<%=rs.getString("price") %>"></i></td>
											</tr>
											<tr>
												<td colspan="2" align="center">
												<input type="submit" value="Update" style="color:black;background-color:orange;" class="btn btn-info btn"></input></td>
											<%
												}
											%>
										</tr>
